...
void OTable_RecycleMem (OTable_Object (* _module)) {
  ...
  void _RecycleObject (OTable_Object _obj) {
    if ((void*)_obj!=(void*)NULL)  {
      ...
      if (!IN(DEREF(OTable_Object, _obj, 9713)._mode, 0x80000000UL, 9719)&&_MnolevOk(DEREF(OTable_Object, _obj, 9752)._mnolev, _mnolev))  {
...
OTable_Struct OTable_NewStruct (SHORTINT _form) {
  ...
  DEREF(OTable_Struct, _str, 19471)._size = (-2147483647L-1);
  return _str;
  NO_RETURN (19288);
}
