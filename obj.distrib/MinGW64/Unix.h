...
extern INTEGER fputc (INTEGER c, LONGINT stream);
extern INTEGER fputs (const CHAR (* s), LONGINT stream);
extern INTEGER fgetc (LONGINT stream);
extern LONGINT fgets (CHAR (* Unix_s), INTEGER count, LONGINT stream);
