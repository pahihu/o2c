...
static void OParse_StatementSeq (OEParse_Node (* _r), OEParse_Node _proc, OEParse_Node _loop) {
  ...
  void _Statement (OEParse_Node (* _node)) {
    ...
    if (OScan_sym==OScan_ident)  {
      ...
      DEREF(OTable_Const, DEREF(OEParse_Node, _n, 34725)._conval, 34733)._intval = 9223372036854775807LL;
      DEREF(OTable_Const, DEREF(OEParse_Node, _n, 34769)._conval, 34777)._intval2 = (-9223372036854775807LL-1);
