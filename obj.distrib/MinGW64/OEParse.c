...
const SET OEParse_intSet = 0x0000000000000038ULL;
const SET OEParse_realSet = 0x00000000000000C0ULL;
const SET OEParse_numSet = 0x00000000000000F8ULL;
static const SET OEParse_nilCompSet = 0x000000000000E000ULL;
static const SET OEParse_arraySet = 0x0000000000060000ULL;
...
static void OEParse_TypeName (OTable_Struct _str, LONGINT __descr_0, CHAR (* _descr)) {
  ...
  if ((void*)DEREF(OTable_Struct, _str, 4039)._obj!=(void*)NULL)  {
    if (DEREF(OTable_Object, DEREF(OTable_Struct, _str, 4087)._obj, 4092)._mnolev<-1LL)  {
...
static SHORTINT OEParse_IntConstType (LONGINT _val) {
  if (-32768LL<=_val&&_val<=32767LL)  {
    return OTable_strShortInt;
  } else if (-2147483648LL<=_val&&_val<=2147483647LL)  {
...
static void OEParse_Convert (OEParse_Node (* _r), SHORTINT _to) {
  OEParse_Node _n;
  if (DEREF(OTable_Struct, DEREF(OEParse_Node, (* _r), 6654)._type, 6660)._form!=_to&&IN(_to, 0x00000000000000FCULL, 6679))  {
    if (DEREF(OEParse_Node, (* _r), 6718)._class==OEParse_ndConst)  {
      ...
      } else if (_to==OTable_strChar&&(DEREF(OTable_Const, DEREF(OEParse_Node, (* _r), 6998)._conval, 7006)._intval<0LL||DEREF(OTable_Const, DEREF(OEParse_Node, (* _r), 7031)._conval, 7039)._intval>255LL))  {
        OEParse_Err(256);
      } else if ((_to==OTable_strShortInt&&DEREF(OTable_Struct, DEREF(OEParse_Node, (* _r), 7163)._type, 7169)._form==OTable_strChar)&&DEREF(OTable_Const, DEREF(OEParse_Node, (* _r), 7193)._conval, 7201)._intval>32767LL)  {
        OEParse_Err(256);
...
void OEParse_Check (OEParse_Node (* _r)) {
  const SET _illegalNode = 0x0000000000000680ULL;
  ...
  BOOLEAN _FoldMOp (SHORTINT _form, SHORTINT _subcl, OTable_Const _c) {
    {
      ...
      switch (_temp_) {
        ...
        case 17: {
          DEREF(OTable_Const, _c, 17129)._intval = 1LL- DEREF(OTable_Const, _c, 17144)._intval;
          break;
        }
        case 21: {
        ...
        case 23: {
          DEREF(OTable_Const, _c, 17521)._intval = MODLI(DEREF(OTable_Const, _c, 17534)._intval, 2LL, 17543);
  ...
  BOOLEAN _FoldDOp (SHORTINT _form, SHORTINT _subcl, OTable_Const _cl, OTable_Const _cr) {
    {
      ...
      switch (_temp_) {
        ...
        case 3: {
          if (DEREF(OTable_Const, _cr, 18793)._intval!=0LL)  {
        ...
        case 4: {
          if (DEREF(OTable_Const, _cr, 18977)._intval!=0LL)  {
        ...
        case 15: {
          if ((0LL<=DEREF(OTable_Const, _cl, 19565)._intval&&DEREF(OTable_Const, _cl, 19580)._intval<=63LL)&&IN(DEREF(OTable_Const, _cl, 19605)._intval, DEREF(OTable_Const, _cr, 19619)._set, 19614))  {
            DEREF(OTable_Const, _cl, 19643)._intval = 1LL;
          } else {
            DEREF(OTable_Const, _cl, 19682)._intval = 0LL;
          }
  ...
  OEParse_Node _FoldBool (SHORTINT _subcl, OEParse_Node _left, OEParse_Node _right) {
    if (DEREF(OEParse_Node, _left, 20323)._class==OEParse_ndConst)  {
      if ((_subcl==OEParse_scOr&&DEREF(OTable_Const, DEREF(OEParse_Node, _left, 20380)._conval, 20388)._intval==0LL)||(_subcl==OEParse_scAnd&&DEREF(OTable_Const, DEREF(OEParse_Node, _left, 20439)._conval, 20447)._intval==1LL))  {
        return _right;
      } else {
        return _left;
      }
    } else if (DEREF(OEParse_Node, _right, 20554)._class==OEParse_ndConst&&((_subcl==OEParse_scOr&&DEREF(OTable_Const, DEREF(OEParse_Node, _right, 20611)._conval, 20619)._intval==0LL)||(_subcl==OEParse_scAnd&&DEREF(OTable_Const, DEREF(OEParse_Node, _right, 20673)._conval, 20681)._intval==1LL)))  {
      return _left;
    } else {
      return (* _r);
    }
  ...
  OTable_Struct _CheckMOp (SHORTINT _subcl, OEParse_Node _left) {
    if (_subcl==OEParse_scMinus)  {
      ...
      OEParse_ChkType(_left, OEParse_grpInteger);
      OEParse_ChkRange(_left, 0LL, -1LL, 266);
  ...
  OTable_Struct _CheckDOp (SHORTINT _subcl, OEParse_Node _left, OEParse_Node _right) {
    ...
    if (IN(_subcl, 0x00000000000000C6ULL, 22977))  {
      ...
      if (IN(_lform, OEParse_numSet, 24216))  {
        ...
        if (_subcl==OEParse_scEql||_subcl==OEParse_scNeq)  {
          if (IN(_lform, 0x0000000000001102ULL, 24778))  {
  ...
  OTable_Struct _CheckAssign (SHORTINT _subcl, OEParse_Node _left, OEParse_Node _right) {
    if (_subcl==OEParse_scExcl||_subcl==OEParse_scIncl)  {
      ...
      OEParse_ChkType(_left, OEParse_grpInteger);
      OEParse_ChkRange(_left, 0LL, -1LL, 268);
      OEParse_ChkType(_right, OEParse_grpExtStd);
  ...
  } else if ((DEREF(OTable_Struct, DEREF(OEParse_Node, (* _r), 29178)._type, 29184)._form==OTable_strBool&&DEREF(OEParse_Node, (* _r), 29208)._class==OEParse_ndDOp)&&IN(DEREF(OEParse_Node, (* _r), 29239)._subcl, 0x0000000000000120ULL, 29247))  {
...
void OEParse_ChkVar (OEParse_Node _n) {
  {
    ...
    switch (_temp_) {
      ...
      case 3: {
        ...
        if (DEREF(OTable_Object, DEREF(OEParse_Node, _n, 29816)._obj, 29821)._mnolev<0LL&&DEREF(OTable_Object, DEREF(OEParse_Node, _n, 29853)._obj, 29858)._mark!=OTable_exportWrite)  {
    ...
    switch (_temp_) {
        ...
        if (_ChkParNum(1))  {
          {
            ...
            switch (_temp_) {
              ...
              case 15: {
                _set = 0x0000000000000058ULL;
                break;
              }
              case 16: {
                _set = 0x0000000000000004ULL;
                break;
              }
              case 17: {
                _set = 0x00000000000000B0ULL;
                break;
              }
      ...
      case 25: {
        ...
        if (_ChkParNum(1))  {
          ...
          OEParse_Check(_call);
          if (_id==OTable_sysADR&&!IN(DEREF(OEParse_Node, _apar, 36145)._class, 0x000000000000037EULL, 36153))  {
          ...
          if (_id==OTable_sysADR&&IN(DEREF(OEParse_Node, _apar, 36454)._class, 0x000000000000030EULL, 36462))  {
      ...
      case 30: {
        ...
        if (_numPar==1)  {
          _CreateConst(&(DEREF(OEParse_Node, _apar, 37751)._link), 0LL);
        ...
        if (_ChkParNum(2))  {
          ...
          _ChkConst(2);
          if (DEREF(OTable_Const, DEREF(OEParse_Node, DEREF(OEParse_Node, (* _call), 38075)._right, 38082)._conval, 38090)._intval<0LL||DEREF(OTable_Const, DEREF(OEParse_Node, DEREF(OEParse_Node, (* _call), 38110)._right, 38117)._conval, 38125)._intval>_ArrayDim(DEREF(OEParse_Node, _apar, 38148)._type, FALSE))  {
      ...
      case 42: {
        ...
        if ((_id==OTable_predINC||_id==OTable_predDEC)&&_numPar==1)  {
          _CreateConst(&(DEREF(OEParse_Node, _apar, 39238)._link), 1LL);
      ...
      case 43: {
        ...
        if (_ChkParNum((INTEGER) (_ArrayDim(DEREF(OTable_Struct, DEREF(OEParse_Node, _apar, 40143)._type, 40149)._base, TRUE)+2LL)))  {
          OEParse_ChkType(_apar, OTable_strPointer);
          OEParse_ChkVar(_Find(1));
          if (_numPar>1)  {
      ...
      case 45: {
        ...
        if (_ChkParNum(1))  {
          ...
          OEParse_ChkRange(_apar, 0LL, 255LL, 267);
        }
        break;
      }
      case 46: {
        ...
        if (_numPar==1)  {
          _CreateConst(&(DEREF(OEParse_Node, _apar, 41423)._link), 1LL);
        ...
        if (_ChkParNum(2))  {
          ...
          OEParse_ChkRange(DEREF(OEParse_Node, (* _call), 41693)._left, 0LL, 255LL, 267);
        }
        break;
      }
      case 37: {
